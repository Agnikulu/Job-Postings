...
- **Open positions:** 324
- **All-time tracked:** 747
- **Active companies:** 139
- **Last run (raw / matched):** 31324 postings fetched, 322 passed filters
...
<details>
<summary><b>Closed positions (423)</b> &mdash; click to expand</summary>


| Company | Role | Location | Source | Education | Apply | Date Posted |
|---------|------|----------|--------|-----------|-------|-------------|
| ~~Meta~~ | ~~Partner Engineer, Generative AI 🇺🇸~~ | Menlo Park, CA | linkedin | - | Closed | Aug 23, 2026 |
