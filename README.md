...
- **Open positions:** 331
- **All-time tracked:** 751
- **Active companies:** 139
- **Last run (raw / matched):** 29368 postings fetched, 329 passed filters
...
<details>
<summary><b>Closed positions (420)</b> &mdash; click to expand</summary>


| Company | Role | Location | Source | Education | Apply | Date Posted |
|---------|------|----------|--------|-----------|-------|-------------|
| ~~CrowdStrike~~ | ~~Associate Security Engineer (Remote) 🇺🇸~~ | USA - Remote, TX | workday | - | Closed | Aug 20, 2026 |
