...
- **Last run (raw / matched):** 31664 postings fetched, 308 passed filters
- **Last updated:** `2026-08-29 12:51 UTC`
...
| Company | Role | Location | Source | Education | Apply | Date Posted |
|---------|------|----------|--------|-----------|-------|-------------|
| ~~Qualcomm~~ | ~~Software Engineer - Edge AI/Gen AI 🇺🇸~~ | San Diego, CA | linkedin | - | Closed | Aug 29, 2026 |
