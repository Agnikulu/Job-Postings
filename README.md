...
- **Last run (raw / matched):** 29685 postings fetched, 358 passed filters
...
<details>
<summary><b>Closed positions (48)</b> &mdash; click to expand</summary>


| Company | Role | Location | Source | Education | Apply | Date Posted |
|---------|------|----------|--------|-----------|-------|-------------|
| ~~Tesla~~ | ~~Inbound Material Flow Engineer 🇺🇸~~ | Austin, TX | linkedin | - | Closed | Jul 03, 2026 |
