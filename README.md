...
- **Open positions:** 263
- **All-time tracked:** 569
- **Active companies:** 139
- **Last run (raw / matched):** 31238 postings fetched, 263 passed filters
...
| Company | Role | Location | Source | Education | Apply | Date Posted |
|---------|------|----------|--------|-----------|-------|-------------|
| ~~Qualcomm~~ | ~~CPU/DSP Performance Engineer 🇺🇸~~ | San Diego, CA | linkedin | - | Closed | Jul 30, 2026 |
